...
defaultSettings = [
    ...
    ("INSTRUCTION DURATION", "30", "How many seconds to show the Instruction scene for before switching to the Bar scene"),
    ("FAIL DURATION", "10", "How many seconds to show the Fail scene for before switching back to the Normal scene"),
    ("", "", ""),
    ("NORMAL SCENE", "Normal", "OBS Scene name for your normal game scene"),
    ("INSTRUCTION SCENE", "Instruction", "OBS Scene name for the scene giving instructions for rip and tear"),
    ("BAR SCENE", "Bar", "OBS Scene name for the scene with the bar in it"),
    ("RIP AND TEAR SCENE", "Rip and Tear", "OBS Scene name for the rip and tear scene if the chat fills the bar"),
    ("FAIL SCENE", "Fail", "OBS Scene name for if chat fails to fill the bar"),
]
